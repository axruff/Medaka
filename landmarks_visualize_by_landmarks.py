...
def make_single_landmark_figure_centered(im, land1, landmark_name, name1, color1 = 'red'):
    ...
    fig.suptitle(f"{landmark_name}", color='white')
    #fig.suptitle(f"{landmark_name}    [{name1} and {name2}]    Diff = {diff} px", color='white')
...
def visualize_pair_result(index):
...
def visualize_single_result(index):
